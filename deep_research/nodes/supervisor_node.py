...
from deep_research.states.state_supervisor import ConductResearch,ResearchComplete,SupervisorState
from deep_research.prompt.prompts import lead_researcher_prompt
...
supervisor_model = initialize_ollama_model()
